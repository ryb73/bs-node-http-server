# 1053 "odoc_ocamlhtml.ml"

  | 2 ->
# 279 "odoc_ocamlhtml.mll"
         ( print "~" ; token lexbuf )
# 1058 "odoc_ocamlhtml.ml"

  | 3 ->
# 281 "odoc_ocamlhtml.mll"
      ( let s = Lexing.lexeme lexbuf in
...
# 1068 "odoc_ocamlhtml.ml"

  | 4 ->
# 287 "odoc_ocamlhtml.mll"
         ( print "?" ; token lexbuf )
# 1073 "odoc_ocamlhtml.ml"

  | 5 ->
# 289 "odoc_ocamlhtml.mll"
      ( let s = Lexing.lexeme lexbuf in
        let name = String.sub s 1 (String.length s - 2) in
        if Hashtbl.mem keyword_table name then
          raise (Error(Keyword_as_label name, Lexing.lexeme_start lexbuf,
                       Lexing.lexeme_end lexbuf));
        print s ; token lexbuf )
# 1083 "odoc_ocamlhtml.ml"

  | 6 ->
# 296 "odoc_ocamlhtml.mll"
      ( let s = Lexing.lexeme lexbuf in
          try
          ...
          with Not_found ->
            (print s ; token lexbuf ))
# 1093 "odoc_ocamlhtml.ml"

  | 7 ->
# 303 "odoc_ocamlhtml.mll"
      ( print_class constructor_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1098 "odoc_ocamlhtml.ml"

  | 8 ->
# 305 "odoc_ocamlhtml.mll"
      ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1103 "odoc_ocamlhtml.ml"

  | 9 ->
# 307 "odoc_ocamlhtml.mll"
      ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1108 "odoc_ocamlhtml.ml"

  | 10 ->
# 309 "odoc_ocamlhtml.mll"
      ( reset_string_buffer();
...
# 327 "odoc_ocamlhtml.mll"
      (
        ...
        print_comment ();
        token lexbuf )
# 1148 "odoc_ocamlhtml.ml"

  | 15 ->
# 334 "odoc_ocamlhtml.mll"
      ( reset_comment_buffer ();
        comment_start_pos := [Lexing.lexeme_start lexbuf];
        comment lexbuf ;
        print_comment ();
...
# 1158 "odoc_ocamlhtml.ml"

  | 16 ->
# 341 "odoc_ocamlhtml.mll"
...
# 1170 "odoc_ocamlhtml.ml"

  | 17 ->
# 351 "odoc_ocamlhtml.mll"
      (
        print (Lexing.lexeme lexbuf);
        token lexbuf
      )
# 1178 "odoc_ocamlhtml.ml"

  | 18 ->
# 355 "odoc_ocamlhtml.mll"
         ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1183 "odoc_ocamlhtml.ml"

  | 19 ->
# 356 "odoc_ocamlhtml.mll"
         ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1188 "odoc_ocamlhtml.ml"

  | 20 ->
# 357 "odoc_ocamlhtml.mll"
         ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1193 "odoc_ocamlhtml.ml"

  | 21 ->
# 358 "odoc_ocamlhtml.mll"
         ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1198 "odoc_ocamlhtml.ml"

  | 22 ->
# 359 "odoc_ocamlhtml.mll"
         ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1203 "odoc_ocamlhtml.ml"

  | 23 ->
# 360 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1208 "odoc_ocamlhtml.ml"

  | 24 ->
# 361 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1213 "odoc_ocamlhtml.ml"

  | 25 ->
# 362 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1218 "odoc_ocamlhtml.ml"

  | 26 ->
# 363 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1223 "odoc_ocamlhtml.ml"

  | 27 ->
# 364 "odoc_ocamlhtml.mll"
         ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1228 "odoc_ocamlhtml.ml"

  | 28 ->
# 365 "odoc_ocamlhtml.mll"
         ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1233 "odoc_ocamlhtml.ml"

  | 29 ->
# 366 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1238 "odoc_ocamlhtml.ml"

  | 30 ->
# 367 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1243 "odoc_ocamlhtml.ml"

  | 31 ->
# 368 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1248 "odoc_ocamlhtml.ml"

  | 32 ->
# 369 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1253 "odoc_ocamlhtml.ml"

  | 33 ->
# 370 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1258 "odoc_ocamlhtml.ml"

  | 34 ->
# 371 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1263 "odoc_ocamlhtml.ml"

  | 35 ->
# 372 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1268 "odoc_ocamlhtml.ml"

  | 36 ->
# 373 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1273 "odoc_ocamlhtml.ml"

  | 37 ->
# 374 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1278 "odoc_ocamlhtml.ml"

  | 38 ->
# 375 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1283 "odoc_ocamlhtml.ml"

  | 39 ->
# 376 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1288 "odoc_ocamlhtml.ml"

  | 40 ->
# 377 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1293 "odoc_ocamlhtml.ml"

  | 41 ->
# 378 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1298 "odoc_ocamlhtml.ml"

  | 42 ->
# 379 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1303 "odoc_ocamlhtml.ml"

  | 43 ->
# 380 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1308 "odoc_ocamlhtml.ml"

  | 44 ->
# 381 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1313 "odoc_ocamlhtml.ml"

  | 45 ->
# 382 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1318 "odoc_ocamlhtml.ml"

  | 46 ->
# 383 "odoc_ocamlhtml.mll"
         ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1323 "odoc_ocamlhtml.ml"

  | 47 ->
# 384 "odoc_ocamlhtml.mll"
         ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1328 "odoc_ocamlhtml.ml"

  | 48 ->
# 385 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1333 "odoc_ocamlhtml.ml"

  | 49 ->
# 386 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1338 "odoc_ocamlhtml.ml"

  | 50 ->
# 387 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1343 "odoc_ocamlhtml.ml"

  | 51 ->
# 388 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1348 "odoc_ocamlhtml.ml"

  | 52 ->
# 389 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1353 "odoc_ocamlhtml.ml"

  | 53 ->
# 391 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1358 "odoc_ocamlhtml.ml"

  | 54 ->
# 392 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1363 "odoc_ocamlhtml.ml"

  | 55 ->
# 393 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1368 "odoc_ocamlhtml.ml"

  | 56 ->
# 394 "odoc_ocamlhtml.mll"
         ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1373 "odoc_ocamlhtml.ml"

  | 57 ->
# 397 "odoc_ocamlhtml.mll"
            ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1378 "odoc_ocamlhtml.ml"

  | 58 ->
# 399 "odoc_ocamlhtml.mll"
            ( print_class kwsign_class (Lexing.lexeme lexbuf) ; token lexbuf )
# 1383 "odoc_ocamlhtml.ml"

  | 59 ->
# 401 "odoc_ocamlhtml.mll"
            ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1388 "odoc_ocamlhtml.ml"

  | 60 ->
# 403 "odoc_ocamlhtml.mll"
            ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1393 "odoc_ocamlhtml.ml"

  | 61 ->
# 405 "odoc_ocamlhtml.mll"
            ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1398 "odoc_ocamlhtml.ml"

  | 62 ->
# 407 "odoc_ocamlhtml.mll"
            ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1403 "odoc_ocamlhtml.ml"

  | 63 ->
# 409 "odoc_ocamlhtml.mll"
            ( print (Lexing.lexeme lexbuf) ; token lexbuf )
# 1408 "odoc_ocamlhtml.ml"

  | 64 ->
# 410 "odoc_ocamlhtml.mll"
        ( () )
# 1413 "odoc_ocamlhtml.ml"

  | 65 ->
# 412 "odoc_ocamlhtml.mll"
      ( raise (Error(Illegal_character ((Lexing.lexeme lexbuf).[0]),
                     Lexing.lexeme_start lexbuf, Lexing.lexeme_end lexbuf)) )
# 1419 "odoc_ocamlhtml.ml"
...
# 1448 "odoc_ocamlhtml.ml"

  | 2 ->
# 472 "odoc_ocamlhtml.mll"
      ( let st = List.hd !comment_start_pos in
        raise (Error (Unterminated_comment, st, st + 2));
      )
# 1455 "odoc_ocamlhtml.ml"

  | 3 ->
# 476 "odoc_ocamlhtml.mll"
      ( store_comment_char(Lexing.lexeme_char lexbuf 0);
        comment lexbuf )
# 1461 "odoc_ocamlhtml.ml"

  | __ocaml_lex_state -> lexbuf.Lexing.refill_buff lexbuf; 
      __ocaml_lex_comment_rec lexbuf __ocaml_lex_state

and string lexbuf =
    __ocaml_lex_string_rec lexbuf 97
and __ocaml_lex_string_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 481 "odoc_ocamlhtml.mll"
      ( () )
# 1473 "odoc_ocamlhtml.ml"

  | 1 ->
# 483 "odoc_ocamlhtml.mll"
      ( string lexbuf )
# 1478 "odoc_ocamlhtml.ml"

  | 2 ->
# 485 "odoc_ocamlhtml.mll"
      ( Buffer.add_string string_buffer (Lexing.lexeme lexbuf) ;
        string lexbuf )
# 1484 "odoc_ocamlhtml.ml"
...
# 1492 "odoc_ocamlhtml.ml"

  | 4 ->
# 493 "odoc_ocamlhtml.mll"
      (  Buffer.add_string string_buffer (Lexing.lexeme lexbuf) ;
         string lexbuf )
# 1498 "odoc_ocamlhtml.ml"

  | 5 ->
# 496 "odoc_ocamlhtml.mll"
      ( raise (Error (Unterminated_string,
                      !string_start_pos, !string_start_pos+1)) )
# 1504 "odoc_ocamlhtml.ml"

  | 6 ->
# 499 "odoc_ocamlhtml.mll"
      ( store_string_char(Lexing.lexeme_char lexbuf 0);
        string lexbuf )
# 1510 "odoc_ocamlhtml.ml"
